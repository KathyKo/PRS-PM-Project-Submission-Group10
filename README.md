...
| **Zhang Yuxuan** | A0285664N  | 1. Prepare training dataset from Fit3D dataset. <br>2. Build GRU model for motion reocgnition and AutoEncoder model for motion correction. <br>3. Preprocess the data, train the model. <br>4. Final visualization of the correction. | e1216649@u.nus.edu |
